export const metadata = {
  title: "Date Picker",
  description: "A date picker component built with the Calendar and Dropdown components.",
...
<PropsTable
  definition={{
    placeholder: {
      type: "string",
      description: "The placeholder text to display when the date picker is empty.",
    },
    variant: {
