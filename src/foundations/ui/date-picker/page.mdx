---
title: Date Picker
description: A date picker component built with the Calendar and Menu components.
preview: date-picker
files:
...
Extends the [`Menu`](/ui/menu) component.

### DatePicker.Trigger

Extends the [`Menu.Trigger`](/ui/menu) component.
