...
<PropsTable
  definition={{
    value: {
      type: "T | T[]",
      description: "The controlled value of the listbox. Can be a single value or an array for multiple selection.",
      required: true,
    },
    onChange: {
      type: "(value: T | T[]) => void",
    ...
    placement: {
      ...
      description: "The placement of the options relative to the trigger. Use 'selection' to align with the selected option.",
      default: '"selection"',
    },
    getIsSelected: {
      type: "(a: T, b: T) => boolean",
      description: "Custom comparison function to determine if two values are equal.",
    },
    matchReferenceWidth: {
      type: "boolean",
...
<PropsTable
  definition={{
    isLoading: {
      type: "boolean",
      description: "When true, replaces the leading magnifying-glass icon with a spinner. Useful for async-filtered lists.",
      default: "false",
    },
  }}
/>
