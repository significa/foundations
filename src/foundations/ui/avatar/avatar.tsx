...
const avatarStyle = cva({
  base: "bg-foreground-secondary/10 text-foreground/80 relative flex items-center justify-center overflow-hidden font-semibold shadow-[inset_0_0_0_1px_--alpha(var(--color-foreground)/8%)] backdrop-blur-sm",
  variants: {
    variant: {
      circle: "rounded-full",
      square: "rounded-md",
