...
const avatarStyle = cva({
  base: "bg-foreground-secondary/10 shadow-[inset_0_0_0_1px_theme(colors.foreground.DEFAULT/0.08)] backdrop-blur-sm flex items-center justify-center overflow-hidden text-foreground/80 font-semibold relative",
  variants: {
    variant: {
      circle: "rounded-full",
      square: "rounded-md",
