    ...
    <Dropdown>
      ...
      <DropdownItems>
        <DropdownItem className="flex flex-col items-start gap-1 text-left">
          ...
          <div className="text-foreground-secondary text-sm">This is a description for the first item</div>
        </DropdownItem>
        <DropdownItem className="flex flex-col items-start gap-1 text-left">
          <div className="font-medium">Custom Item 2</div>
          <div className="text-foreground-secondary text-sm">This is a description for the second item</div>
        </DropdownItem>
