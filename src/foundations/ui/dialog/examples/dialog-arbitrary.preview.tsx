...
import { Dialog, DialogClose, DialogContent, DialogTrigger } from "@/foundations/ui/dialog/dialog";
    ...
    <Dialog>
      ...
      <DialogContent className="p-0">
        ...
        <div className="flex flex-col items-center rounded-2xl p-6">
          ...
          <p className="text-foreground-secondary mb-4 text-sm">Software Engineer</p>
