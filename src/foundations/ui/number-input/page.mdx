...
<PropsTable
  definition={{
    ...
    size: { type: ['"xs"', '"sm"', '"md"', '"lg"'], default: '"md"', description: "Forwarded to the underlying `Input.Group`." },
    variant: { type: ['"default"', '"minimal"'], default: '"default"', description: "Forwarded to the underlying `Input.Group`." },
...
<Preview slug="number-input-sizes" />
