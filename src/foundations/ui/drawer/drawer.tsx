import { Modal, ModalClose, ModalContent, ModalDescription, ModalTitle, ModalTrigger } from "@/foundations/ui/modal/modal";
...
const DrawerTitle = ({ children, className, ...props }: React.ComponentProps<typeof ModalTitle>) => {
  return (
...
const DrawerDescription = ({ children, className, ...props }: React.ComponentProps<typeof ModalDescription>) => {
  return (
...
const DrawerBleed = ({ className, ...props }: React.ComponentPropsWithRef<"div">) => {
  return <div className={cn("-mx-(--drawer-p)", className)} {...props} />;
};

const DrawerHeader = ({ className, children, ...props }: React.ComponentPropsWithRef<"div">) => {
  return (
    <DrawerBleed
      className={cn("bg-background border-border sticky top-0 z-10 mb-(--drawer-p) border-b p-(--drawer-p)", className)}
      {...props}
      data-drawer-header=""
    >
      {children}
...
const DrawerActions = ({ className, children, ...props }: React.ComponentPropsWithRef<"div">) => {
  return (
    <DrawerBleed
      className={cn("bg-background border-border sticky bottom-0 mt-auto flex gap-2 border-t p-(--drawer-p)", className)}
      {...props}
      data-drawer-actions=""
    >
      {children}
