...
Renders a hidden `<input>` for native form submission. Only needed when the OTP field is inside a `<form>`.
...
<PropsTable
  definition={{
    name: {
      type: "string",
      required: true,
      description: "The name of the hidden input used for form submission.",
    },
  }}
/>
