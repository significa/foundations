export const metadata = {
  title: "Modal",
  description:
    "Modal provides a way to display content in a layer above the main interface, using the native HTML dialog element.",
...
- **Native Dialog**: Built on the HTML `<dialog>` element for optimal accessibility
