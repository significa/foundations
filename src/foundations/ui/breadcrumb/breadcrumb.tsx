...
const Breadcrumb = ({ ref, className, ...props }: React.ComponentPropsWithRef<"nav">) => {
  return <nav ref={ref} aria-label="breadcrumb" className={cn("text-sm", className)} {...props} />;
};
...
const BreadcrumbLink = ({ ref, className, asChild, ...props }: BreadcrumbLinkProps) => {
...
const BreadcrumbPage = ({ ref, className, asChild, ...props }: BreadcrumbPageProps) => {
...
const BreadcrumbEllipsis = ({ className, ...props }: React.ComponentPropsWithRef<"span">) => {
  return (
    <span
      role="presentation"
      aria-hidden="true"
