...
For projects that already have motion installed, this hook already exists [here](https://motion.dev/docs/react-use-reduced-motion). Also, to note tailwindcss has `motion-reduce`
