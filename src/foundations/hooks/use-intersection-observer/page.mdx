export const metadata = {
  ...
  description: "A hook for observing the intersection of an element (or array of elements) with the viewport",
  files: ["src/foundations/hooks/use-intersection-observer/use-intersection-observer.ts"],
};
