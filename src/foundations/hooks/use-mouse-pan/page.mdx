...
- **Native Scroll Integration** - Preserves native scrolling behaviour for wheel and touch events, allowing for a seamless cross-device experience
...
<Preview slug="use-mouse-pan-clickables" />
