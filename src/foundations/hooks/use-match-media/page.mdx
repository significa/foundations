export const metadata = {
  title: "useMatchMedia",
  description: "A hook that uses the matchMedia API to observe a media query",
  files: ["src/foundations/hooks/use-match-media/use-match-media.ts"],
};

## Features

- **Media Query Support**: Observe any CSS media query for responsive behaviour
...
<PropsTable
  definition={{
    ...
    initialValue: {
      type: "boolean",
      default: "false",
      description: "Initial value for the media query match",
    },
  }}
/>
