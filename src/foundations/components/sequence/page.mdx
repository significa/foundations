---
title: Sequence
description: A component for creating timed sequences of content with automatic progression.
preview: sequence
files:
  - src/foundations/components/sequence/sequence.tsx
dependencies:
...
<PropsTable
  definition={{
    forceMount: {
      type: "boolean",
      description: "Whether to always mount the panel, regardless of whether it is active.",
      default: "false",
    },
    asChild: {
      type: "boolean",
