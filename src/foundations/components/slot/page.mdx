---
title: Slot
description: A utility component that merges its props onto its immediate child.
files:
  - src/foundations/components/slot/slot.tsx
...
<PropsTable
  definition={{
    ...
    children: {
      ...
      description: "Render function that receives the child and returns a React element.",
      required: true,
    },
  }}
/>
