...
import { Stack, StackHeader, StackItem } from "@/foundations/components/stack/stack";
          ...
          {[1, 2, 3].map((num) => (
            <StackItem key={num} className="bg-background px-4">
              ...
              <div className="text-foreground-secondary py-2">
                This section demonstrates the default top sticky behavior where headers stick to the top of the viewport as you
                scroll down.
              </div>
            </StackItem>
          ))}
        ...
        <Stack stick="bottom">
          {[1, 2, 3].map((num) => (
            <StackItem key={num} className="bg-background px-4">
              ...
              <div className="text-foreground-secondary py-2">
                This section shows how headers can stick to the bottom of the viewport when using stick=bottom. This is useful
                for bottom-up navigation patterns.
              </div>
            </StackItem>
          ))}
        </Stack>
