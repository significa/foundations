  ...
  test:
    ...
    - name: Copy Playwright Report to Public Folder
      run: |
        ...
        cp -r playwright-report-ci/* static/playwright-report
    - name: Set Node.js Version for Vercel
...
9. Copy the new report and replace the reports in the public folder (in this case, in nextjs its public, for other frameworks like SvelteKit, its static)
