...
description: "A comprehensive guide to setting up performance tracking and bundle analysis for Next.js applications"
    ...
    assert: {
      ...
      assertions: {
        ...
        "categories:performance": [
          "error",
          {
            minScore: process.env.PERF_THRESHOLD ? parseFloat(process.env.PERF_THRESHOLD) / 100 : 0.6,
          },
        ],
        "categories:accessibility": [
          "error",
          {
            minScore: process.env.A11Y_THRESHOLD ? parseFloat(process.env.A11Y_THRESHOLD) / 100 : 0.8,
          },
        ],
        "categories:best-practices": [
          "error",
          {
            minScore: process.env.BP_THRESHOLD ? parseFloat(process.env.BP_THRESHOLD) / 100 : 0.9,
          },
        ],
        "categories:seo": [
          "error",
          {
            minScore: process.env.SEO_THRESHOLD ? parseFloat(process.env.SEO_THRESHOLD) / 100 : 0.9,
          },
        ],
